...
public class ProductService {
	...
	public Optional<Long> selectOneProduct(Long idx) throws SQLException {
	 ...
	 * 
	 */
	public void registerProduct(ProductDTO.RequestProduct dto) throws SQLException {
	...
	public void updateProduct(Long productId, ProductDTO.UpdateProduct dto)
	...
	public void deleteProduct(Long productId) throws SQLException, IllegalAccessException {
		Long findId = selectOneProduct(productId).orElseGet(() -> null);
		System.out.println(findId);
		if (findId == null) {
