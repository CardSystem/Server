...
public class CardDAO {
	...
	public static ArrayList<CardHistoryDTO> showSearchUidCardList(String keyword) throws SQLException {
        ...
        try {
            conn = dbUtil.getConnection();
            pstmt = conn.prepareStatement("select card_id, user_id, franchisee, payment, balance ,date, f_category, is_ins,ins_month,card_type from card_history where user_id ='"+ searchKeyword +"' order by date desc;");
	...
	public static ArrayList<CardHistoryDTO> showMonthlyCardList(long keyword) throws SQLException {
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
