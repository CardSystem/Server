...
public class DBUtil {
	...
	private final String url = "jdbc:mysql://localhost:3306/card_system?serverTimezone=UTC";//database�̸� = testdb
	private final String user = "root";//�ڽ��� workbench ���̵�
	private final String pass = "1248";//�ڽ��� workbench ���
